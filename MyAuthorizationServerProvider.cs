...
namespace AstoolTechRestFullAPI.customclass
{
    public class MyAuthorizationServerProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override Task ValidateClientAuthentication(OAuthValidateClientAuthenticationContext context)
        {
            ...
            ClientMaster__Rf client = (new ClientMasterRepository()).ValidateClient(clientId, clientSecret);
            if (client == null)
            {
            ...
            else
            {
                ...
                context.OwinContext.Set<ClientMaster__Rf>("ta:client", client);
        ...
        {
            ClientMaster__Rf client = context.OwinContext.Get<ClientMaster__Rf>("ta:client");
